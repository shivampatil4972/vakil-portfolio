...
const translations = {
  en: {
    ...
    faq3q:'Do you handle cases outside Solapur?',
    faq3a:'Yes. While my primary practice is in Solapur, I frequently travel for high-stakes matters before various High Courts and the Supreme Court.',
  ...
  mr: {
    ...
    faq3q:'सोलापूरबाहेरची प्रकरणे स्वीकारता का?',
    faq3a:'होय. माझा प्राथमिक सराव सोलापूरमध्ये असला तरी, मी उच्च न्यायालये आणि सर्वोच्च न्यायालयात प्रकरणांसाठी प्रवास करतो.',
  ...
  hi: {
    ...
    faq3q:'क्या आप सोलापुर के बाहर के मामले लेते हैं?',
    faq3a:'हाँ। हालांकि मेरा प्राथमिक अभ्यास सोलापुर में है, मैं उच्च न्यायालयों और सर्वोच्च न्यायालय में मामलों के लिए अक्सर यात्रा करता हूँ।',
